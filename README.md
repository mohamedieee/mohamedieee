# 👋 Hi, I'm Mohamed Taha (MohamedIEEE)

**Network Automation Engineer | SONiC | CI/CD | Security + GenAI**

I build automation and reliability tooling for large-scale network systems, especially **Linux SONiC**, test orchestration, CI/CD pipelines, observability, and secure automation workflows. I’m expanding deeply into **Security + GenAI**, building policy-aware agents and ML-based intrusion detection.
...
- GenAI + Security (policy-aware agents, tool-use, SecOps)  
- ML-based intrusion detection (IDS pipelines)  
...
**Security + AI:** LLMs, agent frameworks, ML models, IDS  
...
- Build AI-augmented security workflows  
